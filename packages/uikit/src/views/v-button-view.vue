...
<template>
  <v-container orientation="vertical">
    <v-container orientation="vertical" border>
      ...
      <v-list :items="buttonDetailListItems" :extractKeyFn="(item: ListContent) => item.key">
    ...
    <v-container orientation="vertical" :style="buttonShowcaseContainerStyle">
      <v-button v-model:option="message" :action="handleClick" :message="message"> </v-button>
    </v-container>
