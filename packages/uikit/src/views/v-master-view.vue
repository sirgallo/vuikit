...
const masterViewDetailListItems = ref([
  ...
  {
    key: 'keyViewStyle?: { [style: string]: string }',
    content: 'optional styling for the key view',
  },
])
...
<template>
  <v-container orientation="vertical" overflow="auto">
    <v-container orientation="vertical" border>
      <v-title title="vmasterview" border />
      <v-list :items="masterViewDetailListItems" :extractKeyFn="(item: ListContent) => item.key">
